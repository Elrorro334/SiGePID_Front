...
import { ArrowRight, Sparkles, Box, ShieldCheck, Zap } from 'lucide-react';
    ...
    <div className="flex flex-col min-h-[calc(100vh-5rem)]">
      ...
      <section className="relative flex-1 flex items-center justify-center overflow-hidden bg-surface-muted py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8">
          ...
          >
            La forma más <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">inteligente</span> de comprar.
          </motion.h1>
          ...
          >
            Utilizamos árboles de decisión y análisis en tiempo real para recomendarte exactamente lo que necesitas, cuando lo necesitas.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            ...
            >
              ...
              <p className="text-content-muted">Sistema sincronizado para garantizar que siempre recibas lo que compras sin demoras.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-content-muted">Nuestro motor ML en memoria te sugiere productos basados en tu perfil y necesidades.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-content-muted">Transacciones protegidas con encriptación JWT y tolerancia a fallos garantizada.</p>
            </motion.div>
          </div>
        </div>
      </section>
